...
$(function () {
  ...
  function renderNavbar() {
    ...
    function loadNavbar() {
      ...
      $.get(navbarPath, function (data) {
        ...
        $('#navbar').find('.level2').each(function(i,e) {
        ...
        $('#navbar').find('a[href]').each(function (i, e) {
         ...
         //set active item in navbar
         var currentAbsDir = util.getDirectory(util.getAbsolutePath(window.location.pathname));

         $('#navbar').find('a[href]').each(function (i, e) {
           var href = $(e).attr("href");
           var hrefDir = util.getDirectory(util.getAbsolutePath(href));
           if (hrefDir === currentAbsDir) {
             $(e).addClass(active);
             $(e).parents("ul, li").each(function(j,p) {
               $(p).addClass(active);
               $(p).children('a[href]').addClass(active);
             });
           }
         });
  ...
  function renderBreadcrumb() {
    ...
    $('#sidetoc a.active').each(function (i, e) {
      breadcrumb.push({
        href: e.href,
        name: e.innerHTML
      });
